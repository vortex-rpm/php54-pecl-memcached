...
BuildRequires: %{php_base}-devel, %{php_base}-cli, %{php_base}-pear, zlib-devel, libmemcached108-devel
...
%files
%defattr(-, root, root, -)
%doc %{pecl_name}-%{version}/ChangeLog %{pecl_name}-%{version}/CREDITS %{pecl_name}-%{version}/README.markdown
...
%changelog
* Mon Jun 18 2012 Ilya A. Otyutskiy <sharp@thesharp.ru> - 2.0.1-1.vortex
- Initial release based on IUS memcache.
